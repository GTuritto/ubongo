...
| P.13 | One-shot mem | `ubongo send --profile mem "hello"` (also `--profile all`) | the reply, then a "Memory growth since baseline" report for that turn; `all` prints both reports. |
